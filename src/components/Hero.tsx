...
const Hero: React.FC<HeroProps> = ({ description, banner }) => {
  return (
    <section id="education-newtronic" className="relative aspect-video w-full bg-cover bg-center" style={{ backgroundImage: `url(${banner})` }}>
      {/* Descripcion */}
